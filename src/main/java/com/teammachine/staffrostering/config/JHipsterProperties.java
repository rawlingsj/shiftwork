...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "shiftwork@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "shiftwork API";

        private String description = "shiftwork API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "shiftwork";
