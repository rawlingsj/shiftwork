...
/**
 * Performance test for the StaffRosterParametrization entity.
 */
class StaffRosterParametrizationGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the StaffRosterParametrization entity")
        ...
        .pause(10)
        .repeat(2) {
            exec(http("Get all staffRosterParametrizations")
            .get("/api/staff-roster-parametrizations")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created staffRosterParametrization")
                .get("${new_staffRosterParametrization_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created staffRosterParametrization")
            .delete("${new_staffRosterParametrization_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
