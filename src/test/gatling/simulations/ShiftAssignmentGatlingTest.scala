...
/**
 * Performance test for the ShiftAssignment entity.
 */
class ShiftAssignmentGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the ShiftAssignment entity")
        ...
        .pause(10)
        .repeat(2) {
            exec(http("Get all shiftAssignments")
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created shiftAssignment")
                .get("${new_shiftAssignment_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created shiftAssignment")
            .delete("${new_shiftAssignment_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
