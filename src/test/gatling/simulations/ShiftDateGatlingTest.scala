...
/**
 * Performance test for the ShiftDate entity.
 */
class ShiftDateGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the ShiftDate entity")
        ...
        .repeat(2) {
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created shiftDate")
                .get("${new_shiftDate_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created shiftDate")
            .delete("${new_shiftDate_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
