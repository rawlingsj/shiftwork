...
podTemplate(label: label, serviceAccount: 'jenkins', containers: [
  ...
  node(label) {
    git = checkout([$class: 'GitSCM', branches: [[name: '*/master']], doGenerateSubmoduleConfigurations: false, extensions: [], submoduleCfg: [], userRemoteConfigs: [[credentialsId: '0a768e1b-dd34-4001-a607-1ec64ad3cf73', url: 'https://gitlab.com/hughestech/staffservice.git']]])
